        ...
        setContent {
            XPNSRTheme {
                Surface(color = MaterialTheme.colorScheme.background) {
                    TransactionList(getSampleTransactions(), this@TransactionListActivity)
                }
            }
        }
    }
...
@Composable
fun TransactionList(transactions: List<Transaction>, context: Context) {
    LazyColumn {
...
fun getSampleTransactions(): List<Transaction> {
    return listOf(
        ...
        Transaction("Concert Tickets", "23/02/2024", 90.0, TransactionType.EXPENSE, "Entertainment"),
        ...
        Transaction("Theater Tickets", "07/04/2024", 80.0, TransactionType.EXPENSE, "Entertainment"),
